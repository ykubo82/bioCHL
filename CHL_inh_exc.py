...
##
def train_model(epoch, w, b, learning_rate, gamma,  batch_size, update_batch_size, free_time, clamped_time, delay, dt, node_sizes, n_activations, prediction_inp_size, exc_indices, inh_indices, flg_exc_inh=False, pred=False):
  train_accs   = []
  test_accs    = []
...
def run():
 ...
 # indices for the excitatory and inhibitory  neurons
  ...
  return train_model(epoch, w, b, learning_rate, gamma,  batch_size, update_batch_size, free_time, clamped_time, delay, dt, node_sizes, n_activations, prediction_inp_size, exc_indices, inh_indices, flg_exc_inh=flg_exc_inh, pred=pred)
